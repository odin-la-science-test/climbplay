...
export class Game {
  ...
  _finishInit() {
    ...
    const padGeo = new THREE.BoxGeometry(10, 0.2, 4);
    const padMat = new THREE.MeshStandardMaterial({ color: 0x1e293b, roughness: 0.8 });
    this.crashpad = new THREE.Mesh(padGeo, padMat);
    this.crashpad.position.y = -0.1;
    this.crashpad.position.z = 0.5;
    this.crashpad.receiveShadow = true;
    this.scene.add(this.crashpad);
