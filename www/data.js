...
export const CURATED_ROUTES = [
  ...
  // ENTRAINEMENT (Nouveau Mode)
  { mode:'ENTRAINEMENT', id:'e2', name:"Balancement de Base", difficulty:2, grade:'5c', desc:"Apprenez à bouger le torse.", predefined: true },
  { mode:'ENTRAINEMENT', id:'e4', name:"Le Balancier",        difficulty:4, grade:'6b', desc:"Coordination de balancement.", predefined: true },
  { mode:'ENTRAINEMENT', id:'e6', name:"Campus Master",       difficulty:7, grade:'8a', desc:"Force pure des bras, sans pieds.", predefined: true },
  { mode:'ENTRAINEMENT', id:'e7', name:"Techniques Avancées", difficulty:5, grade:'6c', desc:"Apprenez l'adhérence et le crochetage.", predefined: true },
